...
import com.riskyminions.network.AiPlayerClient;
import com.riskyminions.network.messages.PlayerReadyMessage;
import com.riskyminions.network.messages.SetAiPlayerOnReadyMessage;
import com.riskyminions.network.messages.StartGameMessage;
import java.io.File;
...
public class WaitInLobbyController implements Initializable {
  ...
  public void playBackgroundMusic() {
    if (mediaPlayerLobby == null) {
      File file = new File("/mp3/lobbyMusic.mp3");
      // javafx.scene.media.Media media = new javafx.scene.media.Media(file.toURI().toString());
      // mediaPlayerLobby = new javafx.scene.media.MediaPlayer(media);
      // mediaPlayerLobby.play();
    }
  }
