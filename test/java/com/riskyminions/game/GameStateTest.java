...
class GameStateTest {
  ...
  void testCloneGameState() {
    ...
    assertEquals(gameState.getCountriesOwnedByPlayer(player1.getUserKey()),
        clonedGameState.getCountriesOwnedByPlayer(
            player1.getUserKey()));
    assertEquals(gameState.getCountriesOwnedByPlayer(player2.getUserKey()),
        clonedGameState.getCountriesOwnedByPlayer(
            player2.getUserKey()));
    assertEquals(gameState.getCardsByPlayerKey(player1.getUserKey()),
        clonedGameState.getCardsByPlayerKey(player1.getUserKey()));
    assertEquals(gameState.getCardsByPlayerKey(player2.getUserKey()),
