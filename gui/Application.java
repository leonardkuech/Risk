...
public class Application extends javafx.application.Application {
  ...
  public void start(Stage stage) throws IOException {
    try {
      ...
      Image image = new Image("/pictures/lobbyMinion.png");
      ...
      stage.setTitle("RiskyMinions 1.0 - by RiskyMinions.Company");
      stage
          .getIcons()
          .add(new Image(Application.class.getResourceAsStream("/pictures/lobbyMinion.png")));
